package com.example.graphicsproject.navar;
...
import com.example.graphicsproject.navar.network.GeocodeResponse;
import com.example.graphicsproject.navar.network.RetrofitInterface;
import com.example.graphicsproject.navar.network.geocode.Location;
import com.example.graphicsproject.navar.onboarding.DefaultIntro;
import com.example.graphicsproject.navar.utils.UtilsCheck;
import com.example.graphicsproject.navar.utils.PermissionCheck;
    ...
    void Geocode_Call(String address){
        ...
        call.enqueue(new Callback<GeocodeResponse>() {
            ...
            public void onResponse(Call<GeocodeResponse> call, Response<GeocodeResponse> response) {
                ...
                List<com.example.graphicsproject.navar.network.geocode.Result> results=response.body().getResults();
